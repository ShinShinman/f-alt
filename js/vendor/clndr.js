...
(function (factory) {
  ...
  var clndrTemplateShinH = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'>&larr;</span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>&rarr;</span></div>" +
    "</div>" +
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
    "<thead>" +
    "<tr class='header-days'>" +
    ...
    "<% for(var i = 0; i < numberOfRows; i++){ %>" +
      ...
      "<% for(var j = 0; j < 7; j++){ %>" +
      "<% var d = j + i * 7; %>" +
      "<td class='<%= days[d].classes %>' data-day='<%= days[d].day %>'><div class='day-contents'><%= days[d].day %>" +
        "<div class='events-container always-visible'>" +
        /*
  ...
  "</table>";
    ...
    var clndrTemplateShinHDEV = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'>&larr;</span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>&rarr;</span></div>" +
    "</div>" +
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
    "<thead>" +
  ...
  "</table>";
    ...
    var clndrTemplateShinHBackup = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'>&larr;</span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>&rarr;</span></div>" +
    "</div>" +
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
    "<thead>" +
  ...
  var clndrTemplateShinV = "<div class='clndr-controls'>" +
  "<div class='clndr-control-button'><span class='clndr-previous-button'>previous</span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>next</span></div>" +
  "</div>" +
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
  "<% for(var i = 0; i < daysOfTheWeek.length; i++) { %>" +
